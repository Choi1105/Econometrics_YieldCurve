...
for t = 1:T
    ...
    % (4.33)
    pdf1111 = normpdf(Y(t), b11 + phi1*(X(t,1) - b11) + phi2*(X(t,2)-b11) + phi3*(X(t,3)-b11), sqrt(sig2));
    pdf1121 = normpdf(Y(t), b11 + phi1*(X(t,1) - b11) + phi2*(X(t,2)-b12) + phi3*(X(t,3)-b11), sqrt(sig2));
    pdf1211 = normpdf(Y(t), b11 + phi1*(X(t,1) - b12) + phi2*(X(t,2)-b11) + phi3*(X(t,3)-b11), sqrt(sig2));
    pdf2111 = normpdf(Y(t), b12 + phi1*(X(t,1) - b11) + phi2*(X(t,2)-b11) + phi3*(X(t,3)-b11), sqrt(sig2));
    pdf2211 = normpdf(Y(t), b12 + phi1*(X(t,1) - b12) + phi2*(X(t,2)-b11) + phi3*(X(t,3)-b11), sqrt(sig2));
    pdf1221 = normpdf(Y(t), b11 + phi1*(X(t,1) - b12) + phi2*(X(t,2)-b12) + phi3*(X(t,3)-b11), sqrt(sig2));
    pdf2121 = normpdf(Y(t), b12 + phi1*(X(t,1) - b11) + phi2*(X(t,2)-b12) + phi3*(X(t,3)-b11), sqrt(sig2));
    pdf2221 = normpdf(Y(t), b12 + phi1*(X(t,1) - b12) + phi2*(X(t,2)-b12) + phi3*(X(t,3)-b11), sqrt(sig2));
    
    pdf2222 = normpdf(Y(t), b12 + phi1*(X(t,1) - b12) + phi2*(X(t,2)-b12) + phi3*(X(t,3)-b12), sqrt(sig2));
    pdf2212 = normpdf(Y(t), b12 + phi1*(X(t,1) - b12) + phi2*(X(t,2)-b11) + phi3*(X(t,3)-b12), sqrt(sig2));
    pdf2122 = normpdf(Y(t), b12 + phi1*(X(t,1) - b11) + phi2*(X(t,2)-b12) + phi3*(X(t,3)-b12), sqrt(sig2));
    pdf1222 = normpdf(Y(t), b11 + phi1*(X(t,1) - b12) + phi2*(X(t,2)-b12) + phi3*(X(t,3)-b12), sqrt(sig2));
    pdf1122 = normpdf(Y(t), b11 + phi1*(X(t,1) - b11) + phi2*(X(t,2)-b12) + phi3*(X(t,3)-b12), sqrt(sig2));
    pdf1212 = normpdf(Y(t), b11 + phi1*(X(t,1) - b12) + phi2*(X(t,2)-b11) + phi3*(X(t,3)-b12), sqrt(sig2));
    pdf2112 = normpdf(Y(t), b12 + phi1*(X(t,1) - b11) + phi2*(X(t,2)-b11) + phi3*(X(t,3)-b12), sqrt(sig2));
    pdf1112 = normpdf(Y(t), b11 + phi1*(X(t,1) - b11) + phi2*(X(t,2)-b11) + phi3*(X(t,3)-b12), sqrt(sig2));
